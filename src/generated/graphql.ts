...
export type BundleProduct = CustomizableProductInterface & PhysicalProductInterface & ProductInterface & RoutableInterface & {
  ...
  /** @deprecated Use the `custom_attributes` field instead. */
  custom_content?: Maybe<Scalars['String']['output']>;
...
export type CategoriesQuery = { categories: { items: Array<{ id: number | null, name: string | null, url_key: string | null, children: Array<{ id: number | null, name: string | null, url_key: string | null, children: Array<{ id: number | null, name: string | null, url_key: string | null } | null> | null } | null> | null } | null> | null } | null };
